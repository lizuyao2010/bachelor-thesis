...
def Query(q,maps,paths):
    ...
    if res.has_key('matches'):
        ...
        for w in sorted_d:
            ...
            for y in contexts:
                if len(y)>2:
                    None#print q,name,y[0],y[1],y[2],probability_clusterInContext_givenCluster(c,y)
                else:
                    None#print q,name,y[0],y[1],probability_clusterInContext_givenCluster(c,y)
